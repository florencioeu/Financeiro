...
<head>
    <meta charset="UTF-8">
    <title>O tipo de Pagamento</title>
    <link rel="stylesheet" 
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            O Tipo de pagamento foi alterado com sucesso.
          </div>
          <div class="modal-footer">
            <a href="tipo_pagamentos_main.php" class="btn btn-primary">OK</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="modalLabelErro" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a href="tipo_pagamentos_main.php" class="btn btn-danger">Voltar</a>
          </div>
        </div>
      </div>
    </div>
