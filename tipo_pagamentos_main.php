...
?>  
<div class="container">
<a href="incluir_tipo_pagamentos.php" class="btn btn-primary">Novo Tipo Pagamento</a>
<br><br> 
<table class="table table-striped">
  ...
  <tbody>
  <?php
        $sql = "SELECT * FROM tipo_pagamentos order by descricao_tipo"; // Consulta a tabela
   ...
   ?>
    <tr>
      <td><?php echo htmlspecialchars($id_tipo_pagto); ?></td>
      <td><?php echo htmlspecialchars($descricao_tipo); ?></td>
      <td><a href="editar_tipo_pagamentos.php?id_tipo_pagto=<?php echo 
      htmlspecialchars($id_tipo_pagto); ?>" 
      class="btn btn-primary">Editar</a></td>
      <td><a href="#" onclick="confirmarExclusao(<?php echo htmlspecialchars($id_tipo_pagto); ?>)" 
