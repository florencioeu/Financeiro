...
<table id="myTable" class="table table-striped table-bordered dt-responsive nowrap">
  ...
  <tbody>
  <?php
        $sql = "SELECT id_fornecedor,nome_fornecedor FROM fornecedores"; // Consulta a tabela
   ...
   ?>
    <tr>
      ...
      class="btn btn-primary"><i class="material-icons">edit</i></a></td>
      <td><a href="#" onclick="confirmarExclusao(<?php echo htmlspecialchars($id_fornecedor); ?>)" 
      class="btn btn-danger"><i class="material-icons">delete</i></a></td>
    </tr>
    <?php
        }
    ?>
