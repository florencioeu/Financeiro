...
try {"INSERT INTO fornecedores (cpf_cnpj,nome_fornecedor,celular,email,cep,logradouro,numero,complemento,bairro,cidade,estado,contato)"
VALUES(:cpf_cnpj,:nome_fornecedor,:celular,:email,:cep,:logradouro,:numero,:complemento,:bairro,:cidade,:estado,:contato);
