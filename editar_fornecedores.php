...
<body>
    ...
    <form action="processa_editar_fornecedores.php" method="post">
        ...
        <input type="text" id="nome_fornecedor" name="nome_fornecedor" class="form-control"  placeholder="Entre com o nome" value="<?php echo $nome_fornecedor ?>" required>

        <label for="celular">Celular</label>
        <input type="text" id="celular" name="celular" class="form-control"  placeholder="Entre com o Celular" value="<?php echo $celular ?>"> 
