    ...
    if ($stmt->rowCount() > 0) {
        ...
        ?>
            <table class="table table-striped">
                ...
                <tr>
                    <th>Data</th>
                    <th style="text-align: right; color: green">Entrada</th>
                    <th style="text-align: right; color: red">Saída</th>
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)):
            ...
            <td style="text-align: right;"><?php echo number_format($row['entrada'], 2, ",", "."); ?></td>
            <!-- Valor das Saidas formatadas em reais -->
            <td style="text-align: right;"><?php echo number_format($row['saida'], 2, ",", "."); ?></td>
            <?php
