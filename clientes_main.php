    ...
    <script>
        ...
        function confirmarExclusao(id) {
            ...
            document.getElementById('confirmDeleteBtn').onclick = function() {
                window.location.href = "excluir_clientes.php?id_cliente=" + id;
            };
        }
    </script>
</head>
...
?>  
<div class="container">
<a href="incluir_clientes.php" class="btn btn-primary">Novo cliente</a>
<br><br> 
  ...
  <?php
   ...
   ?>
    <tr>
      ...
      <td><a href="editar_clientes.php?id_cliente=<?php echo 
      htmlspecialchars($id_cliente); ?>" 
